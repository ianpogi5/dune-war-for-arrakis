...
export function placeUnits(units: Partial<Record<UnitType, number>>, area: string): EffectStep {
  return {
...
export function placeOneEach(type: UnitType, areas: string[], label: string): EffectStep {
  return {
...
export function placeVehicles(counts: Partial<Record<VehicleType, number>>): EffectStep {
